import pytest
from exercise_2 import add_three_numbers, add_three_numbers_test, log_add_three_numbers


# solution 1
def test_solution_1_standard():
    assert add_three_numbers_test(3, 3, 3) == 9


def test_solution_1_positive():
    assert add_three_numbers_test(-3, 4, 0) == 1


def test_solution_1_negative():
    assert add_three_numbers_test(-3, -1, -4) == -8
...
def test_solution_2(numb_1, numb_2, numb_3, result):
    assert add_three_numbers_test(numb_1, numb_2, numb_3) == result
